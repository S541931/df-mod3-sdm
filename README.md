...
* Use the mkdir command to create a new directory at the specified path.
  - PS: mkdir DemoFile.
  - This created a folder called "DemoFile" in my directory.
...
* Use the copy command to copy a file from the source path to the destination path.
  ...
  - This copied a screenshot of my previous mkdir from the created folder into my E2_FileSystems folder.
...
* Use the Get-Acl command to retrieve the access control list (ACL) for a file or directory.
  ...
  - This checked file permission for mkdir.png
...
* Use the Export-Csv command to export data to a CSV file.
  ...
  - This exported the date in Date Time format, including the day of month, day of week, and the day of year. 
...
* Use the ConvertTo-SecureString command to encrypt sensitive data.
  ...
  - This converts SensitiveData.txt into an encrypted string and places the text in another file called ConvertTo-SecureString_EncryptedData.txt
...
* Use the Get-Acl command to retrieve the access control list (ACL) for a file or directory.
  ...
  - This cheked the permissions of the recently encryped ConvertTo-SecureString_EncryptedData.txt
  - With this command you can check the file permissions for a file, this will let you know if you need to make any changes. 
...
* Use the icacls command to set or modify the access control list (ACL) for a file or directory.
  ...
  - This command allowed me to set the integrity level of ConvertTo-SecureString_EncryptedData.txt
